(function() {
    window.SocialShareButton = {
        ...
        openProfile: function(el) {
            var $parent, appkey, img, site, title, url;
            site = $(el).data('site');
        ...
        share: function(el) {
            ...
            switch (site) {
                ...
                case "facebook":
                    ...
                    break;
                case "linkedin":
                    SocialShareButton.openUrl("https://www.linkedin.com/shareArticle?mini=true&url=" + url);
                    break;
                case "qq":
